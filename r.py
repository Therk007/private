...
bot = telebot.TeleBot('7879783137:AAHGoGK14RKtKI0nEFmvA9WRtrGz3aoVt9s')
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝐃𝐀𝐑𝐊 𝐗 𝐒𝐄𝐑𝐕𝐄𝐑 𝐃𝐃𝐎𝐒 𝐖𝐎𝐑𝐋𝐃 𝗯𝗼𝘁!", reply_markup=markup)
...
def handle_buy_callback(call):
    admin_username = "@RAJOWNER90"  # Replace with your admin username
    coin_plans = {
        "buy_50": "50 coins \n💰 𝗣𝗿𝗶𝗰𝗲: 75 Rs",
        "buy_100": "100 coins \n💰 𝗣𝗿𝗶𝗰𝗲: 150 Rs",
        "buy_200": "200 coins \n💰 𝗣𝗿𝗶𝗰𝗲: 300 Rs"
